<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewDevice.aspx.cs" Inherits="NewDevice" %>
...
<%--<div class="page-header" style="margin-top:0px;padding-top:9px ;margin-bottom:0px;background-color:#0c3c60">
  ...
  <h1><strong style="color:#7dcada">Nuevo Dispositivo</strong></h1>
       </div>
     </div>--%>
        ...
        <div> <h1 style="color:#d1f4eb;  text-align:center">NUEVO DISPOSITIVO</h1>
               ...
               <div class="col-md-4" style=" color:#0c3c60"> 
                 <div class="row" style="margin-left:5px">
                     <div class="col-md-12" style="margin-top:20px"> 
                      <span id="spnNote" style="color:orangered"><strong>Primero fije un ubicacion antes de ingresar cualquier dato</strong></span>
                     </div>
                  </div>
                <div class="row" style="margin-left:5px">
                  ...
                  <div class="row" style="margin-left:5px"> 
                   ...
                   <div class="row" style="margin-left:5px">
                      <div class="col-md-12" style="margin-top:5px">                       
                        <button id="btnCreate" type="button" class="btn btn-primary" onclick="NewDevice();"  style="margin-top:20px ; float:right ; width:100px"<span id="spnEdit">Crear</span></button>   
                       </div>
                   </div>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function ()
    {
        ...
        var latitud = obtenerValorParametro('latitud');
        var longitud = obtenerValorParametro('longitud');
        ...
        var map = new google.maps.Map(document.getElementById('ModalMapPreview'), {
            zoom: 10,
            center: new google.maps.LatLng(4.624335, -74.063644),//4.624335, -74.063644.
...
var Pj72= new google.maps.LatLng(4.76044379902037,-74.0359516773987);
   ...
   //FIN
         ...
         {          
              ...
              var channel = document.getElementById('ddlChannels').selectedIndex.toString() == "0" ? "off" : $('#ddlChannels :selected').val();
              ...
              var antena =   $("#spnAntenaCoberturaValue").html();

              $.ajax({
                  type: "POST",
                  contentType: "application/json; charset=utf-8",
                  url: "/NewDevice.aspx/InsertDevice",
                  data: '{name: "' + name + '", description: "' + description + '", channel: "' + channel + '",  model: "' + model + '", pattern: "' + pattern + '", longitude: "' + longitud + '", latitude: "' + latitud + '"}',
                  dataType: "json",
                  success: function (data) {
     ...
     function Default2() {
          ...
          function EditLocation() {
                  ...
                  window.location.href = '/EditNewLocation.aspx';
          ...
          function GetChannels() {
              $.ajax({
                  type: "POST",
                  contentType: "application/json; charset=utf-8",
                  url: "/NewDevice.aspx/GetChannels",
                  data: '{}',
                  dataType: "json",
                  success: function (data) {
                      ...
                      $.each(lankanListArray, function (key, value) {
                          ...
                          //$("#ddlChannels").append($("<option></option>").val(value.ID).html(value.ID));
          ...
          function GetAvailableChannels(station) {

              $.ajax({
                  type: "POST",
                  contentType: "application/json; charset=utf-8",
                  url: "/EditDevices.aspx/GetAvailableChannels",
                  data: '{antena: "' + station + '"}',
                  dataType: "json",
                  success: function (data) {
          ...
          function ConsultRange() {
              ...
              var latitud = document.getElementById("txtLat").value;
              var longitud = document.getElementById("txtLong").value;
              var method = $('#ddlMethod :selected').val();
